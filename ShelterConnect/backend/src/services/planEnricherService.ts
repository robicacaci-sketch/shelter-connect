...
function buildPrompt(plan: ActionPlan, client: Client): string {
  ...
  return `You are a housing case management specialist creating a personalized action plan for an individual navigating the path to stable housing.
  ...
  "steps": [
    {
      ...
      "what_to_ask_for": "An objective description of what needs to be communicated and requested during this call or visit. Structure it as follows: 1. Context to provide: the situation — ${client.name} is currently experiencing homelessness and needs [specific document or service] 2. The specific request: exactly what document, appointment, service, or confirmation is being sought 3. Key details to mention: which documents are already available, which are missing, and any special circumstance (e.g. has a minor child, is a veteran, recently released from incarceration) that may affect eligibility or speed up the process 4. The closing ask: what specific next step or commitment to request (e.g. 'Schedule an appointment' or 'Mail the form to this address') Write this as a clear, factual description of what to communicate — not tied to any specific role. The person completing this step could be the individual themselves, a volunteer, a family member, or a support worker.",
